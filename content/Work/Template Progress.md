...
- [x] CARE
	...
	- [ ] Changes from requested:
		...
		- Not all text could match the old font size as they weren't options in odoo. I've chosen the next closest in all situations (my usual procedure), but in the footer Kontakt section this causes the KONTAKT text to be the same size as the details where previously it was slightly larger.
- [x] CONA
